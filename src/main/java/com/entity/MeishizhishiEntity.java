...
public class MeishizhishiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public MeishizhishiEntity() {

	}

	public MeishizhishiEntity(T t) {
		try {
    ...
    public String toString() {
        return "Meishizhishi{" +
            "id=" + id +
            ", meishizhishiName=" + meishizhishiName +
            ", meishizhishiPhoto=" + meishizhishiPhoto +
            ", meishizhishiTypes=" + meishizhishiTypes +
            ", insertTime=" + insertTime +
            ", meishizhishiContent=" + meishizhishiContent +
