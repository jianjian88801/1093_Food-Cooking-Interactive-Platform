<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  class="aaaaaa" v-if="sessionTable !='meishi'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="meishiLiuyanText">
                        <el-input type="textarea"  :readonly="ro.meishiLiuyanText" v-model="ruleForm.meishiLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.meishiLiuyanText" label="留言内容" prop="meishiLiuyanText">
                            <span v-html="ruleForm.meishiLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                ...
                this.ro.meishiLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`meishiLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.meishiLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
