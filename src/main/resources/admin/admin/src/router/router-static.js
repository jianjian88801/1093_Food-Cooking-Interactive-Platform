...
import center from '@/views/center'
    ...
    import meishizhishi from '@/views/modules/meishizhishi/list'
    ...
    import dictionaryMeishizhishi from '@/views/modules/dictionaryMeishizhishi/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryMeishizhishi',
        name: '美食知识类型',
        component: dictionaryMeishizhishi
    }
    ,{
        path: '/dictionarySex',
        name: '性别类型',
